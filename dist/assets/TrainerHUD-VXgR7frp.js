import{V as s,j as y,y as k,u as v,x as u,t as f,n as b,h as x}from"./three-CsPdlfT-.js";import{D as C,r as _,B as g}from"./index-DBqUB4fj.js";import"./physics-DAiIzLkS.js";class I{constructor(t,e,i){this.scene=t,this.drill=e,this.profile=i,this.hintsEnabled=!1,this.hintMeshes=[],this.zoneMesh=null,this.labelEl=null,this.hintBtnEl=null,this.resetBtnEl=null,this._buildUI()}_buildUI(){const t=document.getElementById("ui-layer");if(!t)return;const e=C.getProgress(this.drill.id);if(this.labelEl=document.createElement("div"),this.labelEl.style.cssText=`
