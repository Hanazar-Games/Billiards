# 3D Billiards — Announcement History

Archived release announcements from v1.26.8 and earlier. The current announcement lives in [`ANNOUNCEMENT.md`](./ANNOUNCEMENT.md).

## What's New in v1.26.8

### 深度总审计修复 — UI/UX/SFX/BGM + Analyzer Removal Cleanup

本版本围绕“击球分析全部不要”的清理结果继续做全局回查，重点检查 UI/UX、SFX、BGM、LAN、Replay、Settings 和刚刚移除 Shot Analyzer 后的残留入口。
