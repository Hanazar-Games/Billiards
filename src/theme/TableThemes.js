...
export const WOOD_THEMES = {
  classic: {
    rail:        { color: _c('#221a16'), roughness: 0.36, metalness: 0.18 },
    topInsert:   { color: _c('#604328'), roughness: 0.32, metalness: 0.08 },
    round:       { color: _c('#2e231d'), roughness: 0.30, metalness: 0.22 },
    railBevel:   { color: _c('#9c5e26'), roughness: 0.34, metalness: 0.16 },
    apron:       { color: _c('#151313'), roughness: 0.42, metalness: 0.14 },
    leg:         { color: _c('#15100d'), roughness: 0.42, metalness: 0.18 },
    legFace:     { color: _c('#2d2118'), roughness: 0.36, metalness: 0.12 },
  },
  darkWalnut: {
    rail:        { color: _c('#1e1814'), roughness: 0.34, metalness: 0.15 },
    topInsert:   { color: _c('#4a3524'), roughness: 0.30, metalness: 0.06 },
    round:       { color: _c('#282018'), roughness: 0.28, metalness: 0.20 },
    railBevel:   { color: _c('#7a4e22'), roughness: 0.32, metalness: 0.14 },
    apron:       { color: _c('#121010'), roughness: 0.40, metalness: 0.12 },
    leg:         { color: _c('#120e0b'), roughness: 0.40, metalness: 0.16 },
    legFace:     { color: _c('#281e16'), roughness: 0.34, metalness: 0.10 },
  },
  lightOak: {
    rail:        { color: _c('#8a7058'), roughness: 0.40, metalness: 0.10 },
    topInsert:   { color: _c('#a68868'), roughness: 0.36, metalness: 0.05 },
    round:       { color: _c('#7a644e'), roughness: 0.34, metalness: 0.12 },
    railBevel:   { color: _c('#b89a78'), roughness: 0.36, metalness: 0.10 },
    apron:       { color: _c('#5c4a3a'), roughness: 0.44, metalness: 0.08 },
    leg:         { color: _c('#544434'), roughness: 0.44, metalness: 0.10 },
    legFace:     { color: _c('#6e5844'), roughness: 0.38, metalness: 0.08 },
  },
  blackLacquer: {
    rail:        { color: _c('#0f0f0f'), roughness: 0.15, metalness: 0.35 },
    topInsert:   { color: _c('#1a1a1a'), roughness: 0.12, metalness: 0.30 },
    round:       { color: _c('#111111'), roughness: 0.10, metalness: 0.40 },
    railBevel:   { color: _c('#222222'), roughness: 0.14, metalness: 0.32 },
    apron:       { color: _c('#0a0a0a'), roughness: 0.16, metalness: 0.38 },
    leg:         { color: _c('#080808'), roughness: 0.18, metalness: 0.35 },
    legFace:     { color: _c('#141414'), roughness: 0.14, metalness: 0.30 },
  },
};
...
export const METAL_TRIM_THEMES = {
  ...
  gold: {
    ...
    stretcherN:  { color: _c('#b89a58'), roughness: 0.18, metalness: 0.70 },
  ...
  blackChrome: {
    ...
    stretcherN:  { color: _c('#3e3e3e'), roughness: 0.12, metalness: 0.75 },
