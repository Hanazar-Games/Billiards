...
export const TABLE_PROFILES = {
  pool9ft: {
    ...
    cushionHeight: 5,
    cushionWidth: 4,
    pocketRadius: BALL.radius * 2.55,
    cornerPocketRadius: BALL.radius * 2.55,
  ...
  pool8ft: {
    ...
    pocketStyle: 'american',
    ballSet: 'pool57',
    enabledFor: new Set(['freeplay', 'local2p', 'vsai', 'match', 'lan']),
    default: false,
    enabled: true,
  },
  ...
  bar7ft: {
    ...
    cushionHeight: 5,
    cushionWidth: 4,
    pocketRadius: BALL.radius * 2.65,
    cornerPocketRadius: BALL.radius * 2.65,
