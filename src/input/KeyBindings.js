...
export const ACTION_CATEGORIES = [
  {
    ...
    actions: {
      ...
      zoomIn:       { label: '放大',             mac: '⌘ + =',        win: 'Ctrl + =',     mobile: '双指外扩' },
      zoomOut:      { label: '缩小',             mac: '⌘ + -',        win: 'Ctrl + -',     mobile: '双指内捏' },
      orbitLeft:    { label: '轨道左旋',         mac: 'Shift + 左键拖动', win: 'Shift + 左键拖动', mobile: '双指左滑' },
      orbitRight:   { label: '轨道右旋',         mac: 'Shift + 右键拖动', win: 'Shift + 右键拖动', mobile: '双指右滑' },
    },
  },
  {
    id: 'aim',
